...
# PLAYING WITH OTHER VALUES AND DOUBLE CHECKING THEM
...
# costs = [[500, 1000], [600, 300], [500, 1400]]  # These are just example values, replace them with your actual costs
...
# Add constraint that each airplane is at a gate at its arrival time
for i in range(num_planes):
    opt.add(Or(*[X[i][j][arrival_times[i]] for j in range(num_gates)]))
